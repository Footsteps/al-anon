const BASE_URL = "https://al-anon-app.vercel.app";
...
export const seo = {
  home: {
    ...
    description:
      "Find English-speaking Al-Anon meetings in Berlin, discover roundups and submit events.",
    url: `${BASE_URL}/`,
    image: IMAGE,
  },
  meetings: {
  ...
  events: {
    ...
    description:
      "Upcoming English-speaking Al-Anon roundups or events with Al-Anon participation",
    url: `${BASE_URL}/events`,
    image: IMAGE,
  },
  contact: {
